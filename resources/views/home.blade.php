   ...
   <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	...
	<div id="page">
					...
					<div class="row">
			            ...
			            <form action="#" class="search-wrap">
			               <div class="form-group">
			                  ...
			                  <button class="text-center btn btn-primary submit-search" type="submit"><i class="icon-search"></i></button>
			               </div>
			            </form>
			         </div>
		         </div>
					<div class="row">
						<div class="text-left col-sm-12 menu-1">
							<ul>
				...
				<ul class="slides">
			   	<li style="background-image: url(images/img_bg_1.jpg);">
			   		...
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="text-center col-sm-6 offset-sm-3 slider-text">
		...
		<div class="colorlib-product">
			<div class="container">
				<div class="row">
					<div class="text-center col-sm-8 offset-sm-2 colorlib-heading">
						<h2>Best Sellers</h2>
					</div>
				</div>
		...
		<div class="colorlib-partner">
			<div class="container">
				<div class="row">
					<div class="text-center col-sm-8 offset-sm-2 colorlib-heading colorlib-heading-sm">
						<h2>Trusted Partners</h2>
					</div>
				</div>
				<div class="row">
					<div class="text-center col partner-col">
